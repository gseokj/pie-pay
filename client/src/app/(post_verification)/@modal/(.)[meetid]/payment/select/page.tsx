...
const Members = [
    ...
    {memberId: 11, nickname: "류지수", profileImage: faker.image.avatar()},
    {memberId: 12, nickname: "성목", profileImage: faker.image.avatar()},
    {memberId: 13, nickname: "재언", profileImage: faker.image.avatar()},
    {memberId: 14, nickname: "함승찬", profileImage: faker.image.avatar()},
];
const Me =
    {memberId: 2, nickname: "김준수", profileImage: faker.image.avatar()}
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.memberContainer}>
                ...
                <div className={styles.submitButton}><button>알림 보내기</button></div>
            </div>
        </div>
    );
}