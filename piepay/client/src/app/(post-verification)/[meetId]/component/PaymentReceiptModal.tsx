...
export default function PaymentReceiptModal({ payId }: ReceiptProps) {
    const {isReceiptModalOn, changeReceiptModalStatus} = useStore((state) => state);
    ...
    return (
        <>
            <section
                className={`${styles.modalLayout.joinMeetModal} ${isReceiptModalOn && styles.modalOn}`}
            >
                ...
                <div className={styles.paymentModalContentLayout}>
                    ...
                    <button
                        ...
                        onClick={changeReceiptModalStatus}
                    >확인
                    </button>
                </div>
            </section>
            <section
                className={`${styles.modalBackground} ${isReceiptModalOn && styles.modalBackgroundOn}`}
                onClick={changeReceiptModalStatus}
            >
            </section>
        </>
