    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.navigation}>
                <Link href="/" className={styles.buttonContainer} style={ path === "/" ? {color: theme.blue} : {color: theme.blueGray}}>
                    <MeetingIcon color={ path === "/" ? theme.blue : theme.blueGray} />
                    모임
                </Link>
                <Link href="/alarm" className={styles.buttonContainer} style={ path.includes("alarm") ? {color: theme.blue} : {color: theme.blueGray}}>
                    <NotificationIcon color={ path.includes("alarm") ? theme.blue : theme.blueGray} />
                    알림
                </Link>
                <Link href="/mypage/1" className={styles.buttonContainer} style={ path.includes("mypage") ? {color: theme.blue} : {color: theme.blueGray}}>
